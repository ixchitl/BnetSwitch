...
> 本 fork 基于原作者 qiyh99 的 BnetSwitch,保留 GPLv3 许可。已移除广告、激活码、机器指纹遥测和私服更新。启动、账号浏览与本地操作不主动请求战绩服务;点击战绩或刷新段位后才请求暴雪/网易及所需图片。启动战网后的战网自身联网不属于本工具请求。问题反馈请到 [ixchitl/BnetSwitch](https://github.com/ixchitl/BnetSwitch/issues)。网络审计和待验收项目见 [验证说明](docs/local-only-validation.md)。
